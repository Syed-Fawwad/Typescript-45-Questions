...
let personName1 = "ERIC"; //this is name
...
let famous_person = "Albert Einestien";
...
let members = ['shaban', 'izhan', 'ebad', 'omar', 'ali'];
...
//EXERCISE 12
let members1 = ['shaban', 'ebad', 'anas', 'izhan', 'ali'];
let message1 = 'hello how are you?,';
...
//exercise 13
let transportation = ['BMW', 'MERCEDES', 'AUDI', 'KAWASAKI H2R', 'HAYABUSA'];
...
//guest list
let guestList2 = ['ALI', 'SHABAN', 'EBAD', 'ANAS'];
...
//changing guest list
let guestList1 = ['ALI', 'SHABAN', 'EBAD', 'ANAS'];
for (let i = 0; i < guestList1.length; i++) {
    console.log("Respected Friend " + guestList1[i] + ",\nI would like to invite you to dinner at my house.\nTHANK YOU\n");
}
let not_coming = 'SHABAN';
let new_person = 'HASSAN';
...
///MORE GUEST
let guestList = ['ALI', 'SHABAN', 'EBAD', 'ANAS'];
for (let i = 0; i < guestList.length; i++) {
    console.log("Respected Friend " + guestList[i] + ",\nI would like to invite you to dinner at my house.\nTHANK YOU\n");
}
let not_coming1 = 'SHABAN';
let new_person1 = 'HASSAN';
...
let guestList3 = ['ALI', 'SHABAN', 'EBAD', 'ANAS'];
let not_coming2 = 'SHABAN';
let new_person2 = 'HASSAN';
...
let places = ["KARACHI", "HYDERABAD", "SIALKOT", "LARKANA", "LAHORE"];
...
console.log("I COMMENT THIS QUESTION BECAUSE BOTH QUESTION PRESENT IN THE SAME FOLDER.");
...
let sports = ['CRICKET', 'FOOTBALL', 'HOCKEY', 'SWIMMING', 'TANNIS'];
...
//inequality test
console.log("inequality test with strings:", "ipad" != "iphone");
...
console.log("inequality test with numbers", 16 != 11);
//greater than
...
let vegetables = ["potato", "onion", "chilli"];
...
let favFruit = ["MANGO", "BANANA", "PEACH", "APPLE"];
...
const userName1 = ['admin', 'tony stark', 'captain america', 'hulk', 'Dr strange'];
...
let userName = ["shaban", "ebad", "huzaifa", "ibrahim"];
...
let currentuser = ["abDullah", "jAwab", "yaSir", "Rehman"];
let new_user = ["fawwad", "shaban", "yaSir", "ebad", "Rehman"];
...
let pizza = ["pepperoni", "cuban", "BBQ chicken"];
...
let magician1 = ['herry potter', 'hermione granger', 'ron weasley', 'albus dumbledor'];
...
let magician = ['herry potter', 'hermione granger', 'ron weasley', 'albus dumbledor'];
...
let magician2 = ['herry potter', 'hermione granger', 'ron weasley', 'albus dumbledor'];
function copy_array1(arr) {
    return [...arr];
}
function make_great2(magicianarray) {
    for (let i = 0; i < magicianarray.length; i++) {
        magicianarray[i] = "the great " + magicianarray[i];
    }
}
function show_magician2(magicians2) {
